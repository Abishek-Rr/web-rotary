  ...
  <div class="wrap">
    ...
    <form action="options.php" method="post">
      ...
      <table class="rio-table">
        <tr>
          <td><h4><?php _e('Enable','rio_domain'); ?></h4></td>
          <td>:</td>
          <td>
            <input id="rio_settings[enable]" type="checkbox" name="rio_settings[enable]" value="1" <?php checked('1',$rio_options['enable']); ?>>
            <label for="rio_settings[enable]" class="description checkbox_enable"><?php _e('Enable the Plugin','rio_domain'); ?></label>
          </td>
        </tr>
        <tr>
...
function rio_add_options_link(){
  add_menu_page('Rio Emi Calculator', 'Rio Emi Calculator', 'manage_options','rio-emi-calculator-options','rio_options_page', 'dashicons-chart-pie');
}
